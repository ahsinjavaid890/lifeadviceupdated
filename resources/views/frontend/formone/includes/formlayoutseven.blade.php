...
<div class=" birthdate card mb-5 mt-5  s-visa" style="margin-left: 20.5rem;    width: 50%;
padding: 3em;
                              ...
                              <div class="row">
                                 <div style="padding-left: 0px;" class="col-md-6">
                                    <label for="day{{$i}}" class="label-style">Birth date of the oldest Traveller
                                       ...
                                       <div class="custom-form-control">
                                          <input id="dateofbirthfull{{ $i }}" class="inputs-style w-100 " type="text" placeholder="MM/DD/YYYY" name="years[]" data-placeholder="MM/DD/YYYY" style="">
