      ...
      <div class="row birthdate">
         ...
         <div class="col-md-8 visa-insurance" style="padding-top: 10px;padding-bottom: 20px;background:rgba(0,0,0,0.7);padding-left: 0;padding-right: 0;">
            ...
            <div class="col-md-12 text-center" style="padding: 20px 0;">
               <h1 style="font-weight:bold;margin: 0px;color: #FFF;font-size: 38px;"><strong>Super Visa Insurance</strong></h1>
            ...
            <form action="sessions.php?action=info" method="post" class="form form-layout1" role="form">
               ...
               <div id="">
                  ...
                  <div class="col-md-12" style="clear: both;">
                     ...
                     <button type="submit" name="GET QUOTES" id="GET_QUOTES" class="btn btn-danger" style="border: 1px solid rgb(27, 188, 155); padding: 10px 30px; margin-top: 20px; display: block;"><i class="fa fa-list"></i> Get a Quote </button>
                  </div>
               </div>
