	...
	<form action="" method="post">
		<div class="card">
			<div class="card-body">
				...
				<div class="row">
					<div class="col-md-12 col-lg-offset-1 fields" style="max-width: 90%;margin: auto;">
						...
						<div class="row">
							...
							<div class="col-md-12">
								...
								<div class="toggle toggle-transparent toggle-noicon" onclick="information()">
									<div class="toggle active">
										<div class="row" style="border-bottom: 0.1px solid grey;">
										<div class="col-md-6">
										...
										<div class="toggle-content" id="benefiaciary" style="display: block;">
											<div class="form-group">
											<div class="row">
												<div class="col-md-6">
							...
							<div class="row">
							            ...
							            <div class="front">
							                ...
							                <svg version="1.1" id="cardfront" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
							                    ...
							                    <g id="Front">
							                        ...
							                        <text transform="matrix(1 0 0 1 54.1064 428.1723)" id="svgname" class="st2 st5 st6">Malik Abubakar	</text>
							    ...
							    <div class="form-group">
							        ...
							        <div class="field-container mt-3">
							            ...
							            <svg id="ccicon" class="ccicon  mt-3" width="750" height="471" viewBox="0 0 750 471" version="1.1" xmlns="http://www.w3.org/2000/svg"
