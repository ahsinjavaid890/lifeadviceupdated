...
<script>
    ...
    function savecompareplans(savetoplan,plan_id,product_id,coverage_ammount,deductibles,price) 
    {
        ...
        $.ajax({
            type:'POST',
            url: '{{ url("savecompareplans") }}/'+savetoplan+'/'+{{ $rand }}+'/'+plan_id+'/'+product_id+'/'+coverage_ammount+'/'+deductibles+'/'+price,
            cache:false,
            contentType: false,
            processData: false,
