                    ...
                    @for ($orderi = 1; $orderi <= 17; $orderi++)
                                ...
                                @if ($fields['phone'] == 'on')
                                    ...
                                    <div class="col-md-7">
                                        ...
                                        <label for="phonenumbermask" class="d-sm-none">Phone Number<b id="phone_error"
                                                class="text-danger"></b></label>
                                        <div class="custom-form-control">
                                            <input type="text" id="phonenumbermask" name="phone"
                                                placeholder="000-000-0000" data-placeholder="000-000-0000"
                                                inputmode="numeric" required id="phone" class="oldTraveler"
                            ...
                            @if (isset($fields['sum_insured']))
                                @if ($fields['sum_insured'] == 'on')
                                    ...
                                    <div class="col-md-7">
                                        ...
                                        <div class="custom-form-control">
                                            <select required class="form-input" name="sum_insured2"
                                                id="coverageammount">
                        ...
                        @if (array_search('id_6', $orderdata) == $orderi)
                            @if (isset($fields['Country']))
                                @if ($fields['Country'] == 'on')
                                    @if ($data->pro_travel_destination == 'worldwide')
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-7 " style="margin-right:0 !important">
                                                    ...
                                                    <div class="custom-form-control form-select" id="cnt">
                                                        <select style=" width: 386px;border-radius: 1px;"
                                                            onchange="CountryState(this.value)" required
                                                            class="form-input" name="primary_destination"
                                        ...
                                        <div id="canadastate" class="col-md-12" style="display:none;">
                                            <div class="row">
                                                <div class="col-md-5">
                                                    <label style="margin-left: -11.5px;" for="primary_destination"
                                                        class="form-label lables" id="">States In
                                                        Canda</label>
                                                </div>
                                                <div class="col-md-7">
                                    ...
                                    @else
                                        <div class="col-md-5">
                                            <label for="primary_destination" class="form-label lables"
                                                id="">Primary destination in Canada</label>
                                        </div>
                                        <div class="col-md-7">
                        ...
                        @if (array_search('id_8', $orderdata) == $orderi)
                            @if (isset($fields['sdate']) && $fields['sdate'] == 'on' && isset($fields['edate']) && $fields['edate'] == 'on')
                                ...
                                <div class="col-md-7">
                                    ...
                                    <div class="custom-form-control">
                                        <input readonly inputmode="numeric"
                                            ...
                                            placeholder="Start Date" required <?php if($data->pro_supervisa == 1){?>
                                            onchange="supervisayes()" <?php } ?>>
                                        <script>
                                ...
                                <div class="col-md-5 col-xs-12 " style="padding-right:0px;">
                                    <label class="input-label preinfo">End Date of Coverage <i class="fa fa-info"
                                            style="z-index: 99999;"><span>
                                ...
                                <div class="col-md-7">
                                    ...
                                    <label for="departure_date"
                                        style="color: rgb(245, 130, 31);font-size: 17px;height: 19px;line-height: 38px !important;opacity: .6;position: absolute;text-align: center;top:0px;width: 42px;z-index: 2; left:14;">
                                        <i class="fa fa-calendar" onclick=""
                                            style="border-right: 1px solid #666;padding-right: 8px;"></i>
                                    </label>
                                    <div class="custom-form-control">
                        ...
                        @if (array_search('id_4', $orderdata) == $orderi)
                            @if (isset($fields['email']))
                                @if ($fields['email'] == 'on')
                                    <div class="col-md-5">
                                        <label for="savers_email" class="form-label lables"
                                            id="">Email</label>
                                    </div>
                                    <div class="col-md-7">
                            ...
                            @if (isset($fields['traveller_gender']) && $fields['traveller_gender'] == 'on')
                                ...
                                <div class="col-md-7">
                                    <label for="old_traveller_gender" class="d-sm-none">Gender of the Oldest
                                        traveller</label>
                                    <div class="custom-form-control">
                                        <select required class="form-input" name="old_traveller_gender"
                            ...
                            @if (isset($fields['fplan']))
                                @if ($fields['fplan'] == 'on')
                                    ...
                                    <div class="col-md-7">
                                        ...
                                        <div class="custom-form-control">
                                            <select onchange="changefamilyyes(this.value)" required class="form-input"
                                                name="fplan" id="selectfamilyplan">
                                                <option value="">--- Please Choose ---</option>
                                                <option value="yes">Yes</option>
                                                <option selected value="no">No</option>
                                            </select>
