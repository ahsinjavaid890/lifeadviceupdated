                ...
                @csrf
                  ...
                  <div class="row">
                     ...
                     @if(isset($fields['traveller']) && $fields['traveller'] == "on" )
                        ...
                        <div class="col-md-12 ">
                           <label style="font-size: 16px;" for="number_travelers" class="">Number of Travellers</label>
                           ...
                           <div style="display: none;" id="traveler{{ $i }}" class="no_of_travelers col-md-12">
                              <div class="row">
                                 <div style="margin-bottom: -14px" class="col-md-6 padding-right-zero-on-mobile">
                                    <label style="font-size: 16px;" for="year{{$i}}" class="">Birth date of the <?php echo $ordinal_words[$i];?> Traveller</label>
                                    ...
                                    <div style="padding-right: 0px;" class="col-md-6 padding-left-zero-on-mobile">
                                       <div class="custom-form-control">
                                          <label style="font-size: 16px;" for="year{{$i}}" class="">Pre Existing of the <?php echo $ordinal_words[$i];?> Traveller</label>
                     ...
                     @if(isset($fields['Country']))
                        @if($fields['Country'] == "on" )
                           ...
                           <div id="country" class="col-md-12 ">
                              <div class="custom-form-control">
                                 <label for="firstname" class="" style="font-size: 16px;">States In Canada</label>
                           ...
                           @else
                           <div class="col-md-12 " >
                              <label style="font-size: 16px;" for="primary_destination" class="">Primary destination in Canada</label>
                              <div class="custom-form-control">
                                 <select required class="form-input" name="primary_destination" id="primary_destination" style="    padding: 5px 12px !important;">
                                    <option value="">Primary destination in Canada</option>
                                    @foreach(DB::table('primary_destination_in_canada')->get() as $r)
                     ...
                     <div class="col-md-6 ">
                        <label for="firstname" class="" style="font-size: 16px;">First name</label>
                        <div class="custom-form-control">
                     ...
                     @if($fields['lname'] == 'on')
                     <div class="col-md-6 ">
                        <label for="lname" class="" style="font-size: 16px;">Last name</label>
                        <div class="custom-form-control">
               ...
               @endif
                    @if(array_search("id_4",$orderdata) == $orderi)
                     ...
                     <div class="col-md-12  col-sm-12 col-xs-12 control-input email-main">
                        <label style="font-size: 16px;" for="savers_email" class="">Email</label>
                        <div class="custom-form-control">
                     ...
                     @if($fields['phone'] == 'on')
                     <div class="col-md-12 ">
                        <label for="phonenumbermask" class="">Enter Your Phone Number</label>
                        <div class="custom-form-control">
                     ...
                     @if(array_search("id_12",$orderdata) == $orderi)
                      @if(isset($fields['fplan']))
                           @if($fields['fplan'] == 'on')
                                 ...
                                 <div class="col-md-6">
                                 <label style="font-size: 16px;  for="" class="">Do you require Family Plan ?</label>
                                 <div class="custom-form-control">
                     ...
                     <button type="submit" name="GET QUOTES" id="getqoutesubmitbutton" class="btn btn-danger" style="border: 1px solid rgb(27, 188, 155);padding: 10px 30px;;margin-top: 20px;display: block;border-radius: 4px !important;"><i class="fa fa-list"></i> Get a Quote </button>
                  </div>
                  </div>
