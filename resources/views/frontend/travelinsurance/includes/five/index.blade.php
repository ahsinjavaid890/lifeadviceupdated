...
?>
    <div class="row">
        <div class="col-md-3">
            <div class="side-bar filterdiv hidden-xs  quote_reference">
                <small>
                    <?php
            ...
            ?>
                ...
                <h3 class="pt-3" style="margin: 0; font-size: 20px;   color: #000;font-weight: 500; ">
                    <?php echo $quoteNumber; ?>
                </h3>
                <h4 class="deductible"style="font-size: 20px; margin: 0; padding: 0; font-weight: bold;margin-bottom: 0; border: none;text-align: left;">
                    Deductible: <input type="text" id="coverage_deductible" name="coverage_deductible"
                        ...
                        style="border:0; font-size:20px; color:#444; font-weight:bold;background: no-repeat;margin: 0;padding: 0;text-align: center;width: 100px;">
                </h4>

                <div id="slider"
                    style="border: 1px solid #c5c5c5;padding: 5px;box-shadow: 0px 0px 5px 0px inset #CCC;border-radius: 10px;">
                </div>
                <h4 class="coverage" style="font-size: 20px; margin: 0;padding: 0;font-weight: bold;margin-bottom: 0;border: none;text-align: left;">
                    Coverage: <input type="text" id="coverage_amount_for_slider" name="coverage_amount"
                        value="$<?php echo $_REQUEST['sum_insured2'];?>"
                        style="border:0; font-size:20px; color:#444; font-weight:bold;background: no-repeat;margin: 0;padding: 0;text-align: center;width: 150px;">
                </h4>
