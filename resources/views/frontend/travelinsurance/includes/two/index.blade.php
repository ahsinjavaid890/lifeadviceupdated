...
<strong>Plan Type: </strong> <?php if ($family_plan == 'yes') {
    ...
    echo 'Individual';
                                ...
                                <div class="row">
                                    <div class="col-md-12 moredetails_<?php echo $deductible . $plan_id; ?> dh-toggle-show-hide-<?php echo  $deductible . $plan_id; ?>"
...
echo number_format($person_price,2); ?>
                            ...
                            <div class="row buynow_<?php echo $deductible . $plan_id; ?>"
                                ...
                                <div class="col-md-6" style="background:#F9F9F9;padding-top: 10px;padding-bottom: 10px;">
                                    ...
                                    <p><input type="checkbox" required name="agree" style="height: auto;margin: 0;"> I give
