    ...
    <div class="coverage-amt col-md-12 pricearray coverage-amt-{{$second_sum_insured}} pricearray{{ $second_comp_id }}{{ $second_total_price }}" style="<?php echo ( $request->sum_insured2 == $second_sum_insured ) ? '' : 'display:none;'; ?> padding:0; ">
        ...
        @endphp
                        <div style="position: absolute;top: -8px;right: 10px;">
                            <label onclick="savecompareplans('{{ $second_savetoplan }}')" class="mt-2 col-md-12 col-xs-5 comparebutton{{ $second_plan_id }}{{ $data->pro_id }}{{ $second_sum_insured }}{{ $second_deductible }}" style="cursor: pointer" id="compare"><i class="fa fa-database"></i> Compare</label>
                        </div>
