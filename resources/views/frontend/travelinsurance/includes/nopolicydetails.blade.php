<div class="col-md-12 dh-toggle-show-hide-{{ 1+$second_deductible.$second_plan_id }} buynowrow summarydiv moredetails_<?php echo $second_deductible . $second_plan_id; ?> summar_info_<?php echo $second_deductible . $second_plan_id; ?> summary_<?php echo $second_deductible.$second_plan_id;?> dh-toggle-show-hide-<?php echo $second_plan_id; ?>">
    <div class="row">
    <div class="col-12">
