...
@endsection
@section('content')
<div class="container-homepage main-div-login">
   <div class="login-image m-5 text-center">
      <img src="https://www.lifeadvice.ca/images/brand.png">
   </div>
   <div class="card shadow login-card mb-5">
      <div class="card-body">
            <div class="heading-login text-center">
               <h2>Sign Up</h2>
            </div>
          <form class="mt-5" action="#" method="POST">
             <input type="hidden" name="_token" value="15azM06AbWQZrMTreqAEapw45we8onJeIXUjLMZ7">       
              <div class="form-group">
                 <input style="min-height: 58px" class="form-control  rounded-pill" type="text" placeholder="Name" name="name" autocomplete="off">
                </div>       
              <div class="form-group">
                 <input style="min-height: 58px" class="form-control  rounded-pill" type="text" placeholder="Email" name="email" autocomplete="off">
                </div>      
              <div class="form-group">
                 <input style="min-height: 58px" class="form-control  rounded-pill" type="number" placeholder="phone number" name="phone" autocomplete="off">
                </div> 
             <div class="form-group">
