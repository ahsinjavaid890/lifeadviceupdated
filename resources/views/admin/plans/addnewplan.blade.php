             ...
             <div class="panel-body">
                ...
                <div class="original row">
                    <div class="col-md-12" id="links">
                        ...
                        <input id="directlink" name="directlink" class="form-control" placeholder="https://" type="text">
                    </div>
                </div>
                </div>
            </div>
               ...
               <div class="panel-body">
                  ...
                  <div class="row">
                     ...
                     <div class="col-md-12">
                        <!-- radio -->
                        <label class="radio">
                        <input checked type="radio" value="0" name="irateCalculation" id="daily" onclick="tempcall_0();">
                        <i></i> Daily
                        </label>
                        <label class="radio">
                  ...
                  <div class="col-md-12" id="discountrateshow" style="display:none">
                     ...
                     <input id="cdiscountprice" name="cdiscountprice" class="form-control" placeholder="Discount Rate" type="text">
                  </div>
                  <script>
                  ...
                  <div class="col-md-12" id="flatratediv" style="display: none;">
                        ...
                        <label><strong>Flat Rate</strong></label>
                            <input id="iflatrateprice" name="iflatrateprice" placeholder="Flat Rate"class="form-control" type="text">
                        </div>
                    </div>
                  <script>
                   ...
                   <div class="col-md-12" style="margin-top: 10px;">
                    ...
                    <label><strong>Discount Rate (%)</strong></label>
                        <input id="discount_rate" name="discount_rate" placeholder="Discount Rate" class="form-control" type="text">
                  ...
                  <div class="col-md-12" id="stop_usa">
                    ...
                    <div class="col-md-12" style="padding:0;">
                        <input id="smokeprice" name="smokeprice" class="form-control" placeholder="Smoke Rate" type="text">
                    </div>
