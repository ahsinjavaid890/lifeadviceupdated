             ...
             <div class="panel-body">
                    ...
                    <div class="col-md-12">
                        ...
                        <select required name="ipname" id="ipname" class="form-control">
                            ...
                            @foreach(DB::table('wp_dh_products')->get() as $r)
                                <option @if($data->product == $r->pro_id) selected @endif value="{{ $r->pro_id }}" >{{ $r->pro_name }}</option>
                            @endforeach                                        
                        </select>
                    </div>
                </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <select required name="icname" id="icname" class="form-control">
                            ...
                            @foreach(DB::table('wp_dh_companies')->get() as $r)
                                <option @if($data->insurance_company == $r->comp_id) selected @endif value="{{ $r->comp_id }}" >{{ $r->comp_name }}</option>
                            @endforeach                                        
                        </select>
                    </div>
                </div>
                <div class="original row">
                    <div class="col-md-12" id="links">
                        ...
                        <input id="directlink" name="directlink" class="form-control" placeholder="https://" value="{{ $data->directlink }}" type="text">
                    </div>
                </div>
                </div>
            </div>
               ...
               <div class="panel-body">
                  ...
                  <div class="row">
                     ...
                     <div class="col-md-12">
                        ...
                        <input type="checkbox" name="ifeature" id="ifeature" @if($data->feature == 1)  checked @endif value="1">
                  ...
                  <div class="row">
                     ...
                     <div class="col-md-12">
                        <!-- radio -->
                        <label class="radio">
                        <input type="radio" value="0"  @if($data->rate_base == 0) checked="" @endif  name="irateCalculation" id="daily" onclick="tempcall_0();">
                        <i></i> Daily
                        </label>
                        <label class="radio">
                        <input type="radio" value="1"  @if($data->rate_base == 1) checked="" @endif name="irateCalculation" id="daily" onclick="tempcall_0();">
                        <i></i> Monthly
                        </label>
                        <label class="radio">
                        <input type="radio" value="2"  @if($data->rate_base == 2) checked="" @endif name="irateCalculation" id="daily" onclick="tempcall_0();">
                        <i></i> Yearly
                        </label>
                        <label class="radio">
                        <input type="radio" value="3" @if($data->rate_base == 3) checked="" @endif  name="irateCalculation" id="daily" onclick="tempcall_3();">
                        <i></i> Multi
                        </label>
                        <label class="checkbox">
                        <input type="checkbox" @if($data->rate_base == 4) checked="" @endif name="monthlytwo"  id="monthlytwo" value="1">
                     ...
                     <div class="col-md-12">
                        ...
                        <select name="sales_tax" class="form-control">
                           ...
                           <option @if($data->sales_tax == '8% ontario') selected @endif  value="8% ontario" >8% Sales Tax Ontario</option>
                           <option @if($data->sales_tax == '9% quebec') selected @endif value="9% quebec" >9% Sales Tax Quebec</option>
                           <option @if($data->sales_tax == '8% manitoba') selected @endif value="8% manitoba" >8% Sales tax manitoba</option>
                        </select>
                     </div>
                  </div>
                  <div class="col-md-12">
                     <label class="switch switch-success switch-round">
                     <input type="checkbox" @if($data->premedical == 1) checked @endif  name="imedical" id="imedical"  value="1">
                     <span class="switch-label" data-on="YES" data-off="NO"></span>
                  ...
                  <div class="col-md-12">
                     <label class="switch switch-success switch-round">
                     <input type="checkbox" @if($data->family_plan == 1) checked @endif name="ifamily" id="ifamily"  value="1">
                     <span class="switch-label" data-on="YES" data-off="NO"></span>
                  ...
                  <div class="col-md-12">
                     <label class="switch switch-success switch-round">
                     <input @if($data->cdiscountrate == 1) checked @endif type="checkbox" name="cdiscountrate" id="cdiscountrate" class="cdiscountrate"  value="1" onclick="cdiscountratecheck()">
                     <span class="switch-label" data-on="YES" data-off="NO"></span>
                     <strong>Do you want to apply discount on Canadian ?</strong>
                     </label>
                  </div>
                  <div class="col-md-12" id="discountrateshow" @if($data->cdiscountrate == 0) style="display:none" @endif>
                     <label><strong>Canadian Discount Rate</strong></label>
                     <input id="cdiscountprice" name="cdiscountprice" class="form-control" value="{{ $data->cdiscountrate }}" placeholder="Discount Rate" type="text">
                  </div>
                  <script>
                  ...
                  <div class="col-md-12" style="margin-top: 10px;">
                     <label class="switch switch-success switch-round">
                     <input type="checkbox" @if($data->flatrate > 0) checked @endif name="iflat" id="flatratecheck"  value="1" onclick="flatratecheckfunc()">
                     <span class="switch-label" data-on="YES" data-off="NO"></span>
                     <strong>Do you want to add flat rate ?</strong>
                     </label>
                  </div>
                  <div class="col-md-12" id="flatratediv" style="display: <?php if($data->flatrate > '0'){ echo 'block;'; } else { echo 'none'; } ?>">
                        <label class="radio">
                            <input type="radio" value="each" <?php if($data->flatrate_type == 'each'){?> checked="" <?php } ?> name="flatrate_type">
                            <i></i> For Each User
                        </label>
                        <label class="radio">
                            <input type="radio" value="total" <?php if($data->flatrate_type == 'total'){?> checked="" <?php } ?> name="flatrate_type">
                            <i></i> On Total Premium
                        </label>
                        <div class="col-md-12" style="clear:both; padding:0;">
                        <label><strong>Flat Rate</strong></label>
                            <input id="iflatrateprice" name="iflatrateprice" placeholder="Flat Rate" value="<?php echo $data->flatrate;?>" class="form-control" type="text">
                        </div>
                    </div>
                  <script>
                   ...
                   <div class="col-md-12" style="margin-top: 10px;">
                    <label class="switch switch-success switch-round">
                        <input type="checkbox" name="discount" id="discount" <?php if($data->discount == '1'){?> checked="" <?php } ?> value="1" onclick="discountfunc()">
                        <span class="switch-label" data-on="YES" data-off="NO"></span>
                        <strong>Do you want to give discount ?</strong>
                    </label>
                    </div>
                    <div class="col-md-12" id="discountdiv" style="display: <?php if($data->discount == '1'){ echo 'block;'; } else { echo 'none'; } ?>">
                    <label><strong>Discount Rate (%)</strong></label>
                        <input id="discount_rate" name="discount_rate" placeholder="Discount Rate" value="<?php echo $data->discount_rate;?>" class="form-control" type="text">
                  ...
                  <div class="col-md-12" id="stop_usa">
                    <label class="radio">
                        <input type="radio" value="0" <?php if($data->smoke == '0'){?> checked="" <?php } ?> name="smoke" id="smoke">
                        <i></i> Fixed Price ($)
                    </label>
                    <label class="radio">
                        <input type="radio" value="1" <?php if($data->smoke == '1'){?> checked="" <?php } ?> name="smoke" id="smoke">
                        <i></i> Percentage (%)
                    </label>
                    
                    <div class="clear" style="height:15px;"></div>
                    <div class="col-md-12" style="padding:0;">
                        <input id="smokeprice" name="smokeprice" class="form-control" value="<?php echo $data->smoke_rate;?>" placeholder="Smoke Rate" type="text">
                    </div>
...
<div class="panel-body">
   ...
   <div class="daily_monthly" id="daily_monthly" style="<?php if($data->rate_base=='0' || $data->rate_base=='1' || $data->rate_base=='2') { echo 'display:block'; } else {echo 'display:none';}?>">
