...
<div class="aside aside-left aside-fixed d-flex flex-column flex-row-auto" id="kt_aside">
    ...
    <div class="brand flex-column-auto" id="kt_brand">
        ...
        <a style=" background-color: white; margin-top: 15px; border-radius: 11px; " href="{{url('admin/dashboard')}}">
            <img style=" padding: 5px; width: 100%; " alt="Logo" src="{{ url('public/images') }}/{{ Cmf::getwebsite()->header_logo }}" />
        </a>
        <!--end::Logo-->
    </div>
    <!--end::Brand-->
                        ...
                        <ul class="menu-subnav">
                            ...
                            <li class="menu-item" aria-haspopup="true">
                                <a href="{{ url('admin/products/addnewproduct') }}" class="menu-link">
                                    <i class="menu-bullet menu-bullet-dot"><span></span></i><span class="menu-text">Add New Products</span>
                                </a>
                            </li>
                        </ul>
                    </div>
                        ...
                        <ul class="menu-subnav">
                            ...
                            <li class="menu-item" aria-haspopup="true">
                                <a href="{{ url('admin/plans/allplans') }}" class="menu-link">
                                    <i class="menu-bullet menu-bullet-dot"><span></span></i><span class="menu-text">Plans</span>
                                </a>
                            </li>
                            <li class="menu-item" aria-haspopup="true">
                                <a href="{{ url('admin/plans/planbenifits') }}" class="menu-link">
                                    <i class="menu-bullet menu-bullet-dot"><span></span></i><span class="menu-text">Plan Benifits</span>
                                </a>
                            </li>
                            <li class="menu-item" aria-haspopup="true">
                            ...
                            <li class="menu-item" aria-haspopup="true">
                                <a href="{{ url('admin/plans/lifeplanbenifits') }}" class="menu-link">
                                    <i class="menu-bullet menu-bullet-dot"><span></span></i><span class="menu-text">Life Plan Benifits</span>
                                </a>
                            </li>
                        </ul>
                    </div>
                        ...
                        <ul class="menu-subnav">
                            ...
                            <li class="menu-item" aria-haspopup="true">
                                <a href="{{ url('admin/website/settings') }}" class="menu-link">
                                    <i class="menu-bullet menu-bullet-dot"><span></span></i><span class="menu-text">Appearance</span>
                                </a>
                            </li>
                            <li class="menu-item" aria-haspopup="true">
