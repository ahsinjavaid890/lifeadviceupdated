   @extends('admin.layouts.main-layout') @section('title','Edit Product') @section('content') <style>
            ...
            <div class="panel panel-default col-md-8" style="padding:0;">
               ...
               <strong>Enter Product Details</strong>
                ...
                <div class="panel-body">
                  ...
                  <script src="https://cdnjs.cloudflare.com/ajax/libs/jquery-sortable/0.9.13/jquery-sortable.js" integrity="sha512-wkFkHqg/slL8ir7iAoKng3V8+TVkvz+gdm5WIBWfBjgxcaRJ3NW+NHLBBlAAu7F8f2lPJP0MepDh2YRoNJUcZg==" crossorigin="anonymous" referrerpolicy="no-referrer"></script>
              <style>
