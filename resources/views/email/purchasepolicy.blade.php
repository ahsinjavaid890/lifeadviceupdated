                                                                              ...
                                                                              <tr>
                                                                                 <td style="padding:18px 30px 18px 30px;line-height:22px;text-align:inherit;background-color:#2b3481" height="100%" valign="top" bgcolor="#2B3481" role="module-content">
                                                                                    <div>
                                                                                       ...
                                                                                       <div style="font-family:inherit;text-align:inherit"><span style="color:#ffffff;font-family:&quot;Open Sans&quot;,sans-serif;font-size:18px;line-height:40px;font-weight:600">Policy ID:</span><span style="color:#ffffff;font-family:&quot;Open Sans&quot;,sans-serif;font-size:18px;line-height:40px;font-weight:700">{{ $policy_number }}</span></div>
                                                                                       <div></div>
                                                                                    </div>
                                                                                 </td>
                                                                              </tr>
