                                                            ...
                                                            <tr>
                                                               <td class="m_-2565051330621453805mobile-hide-padding" style="padding:25px 34px 18px 34px;line-height:28px;text-align:inherit" height="100%" valign="top" bgcolor="" role="module-content">
                                                                  <div>
                                                                     ...
                                                                     <div style="font-family:&quot;Open Sans&quot;,sans-serif;text-align:inherit;line-height:28px"><span style="color:#67778f;font-weight:600;font-size:16px">Thank you for choosing Life Advice Insurance Inc. to safeguard your journeys. We're excited to help you explore insurance options tailored to your unique travel style! With just a click, you can revisit your plan comparison and secure your policy in under 5 minutes.</span></div>
                                                                     <div></div>
                                                                  </div>
                                                               </td>
                                                            </tr>
                                                         ...
                                                         <tbody>
                                                            <tr>
                                                               <td class="m_-2565051330621453805mobile-hide-padding" style="padding:18px 30px 18px 30px;line-height:28px;text-align:inherit" height="100%" valign="top" bgcolor="" role="module-content">
                                                                  <div>
                                                                     <div style="font-family:&quot;Open Sans&quot;,sans-serif;text-align:inherit;font-size:16px;line-height:28px"><span style="font-size:16px;font-weight:600">We understand that selecting insurance can be overwhelming. Our team of seasoned experts is here to guide you through every step of the process. Reach out to us at</span><a href="tel:+1-855-500-8999" target="_blank"><span style="font-size:16px;font-weight:600;color:#1b8fe4"><strong> +1-855-500-8999</strong></span></a><span style="font-size:16px;font-weight:600"> or email us at </span><a href="mailto:info@lifeadvice.ca" target="_blank"><span style="font-size:16px;font-weight:600;color:#1b8fe4"><strong>info@lifeadvice.ca</strong></span></a><span style="font-weight:600;font-size:16px"> for personalized assistance.</span></div>
                                                                     <div style="font-family:inherit;text-align:inherit"><br></div>
